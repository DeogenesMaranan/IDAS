<div id="resched-modal" class="fixed inset-0 bg-black/50 backdrop-blur-sm hidden flex items-center justify-center z-50 p-0">
    <div class="bg-white rounded-2xl w-full max-w-3xl shadow-2xl relative animate-fadeIn">
        <div class="bg-gradient-to-b from-[#9e1515] to-[#7b0b0b] p-6 rounded-t-2xl">
            ...
            <p class="text-red-100 text-sm mt-1">Select a new date and time for the appointment</p>
        </div>
        <form id="resched-form" class="p-6">
            ...
            <button type="submit" 
                    class="w-full bg-gradient-to-r bg-gradient-to-b from-[#9e1515] to-[#7b0b0b] hover:from-blue-700 hover:to-indigo-700 text-white py-3.5 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-2 mt-6">
